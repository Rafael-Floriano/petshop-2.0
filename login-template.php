...
<body class="img-fluid">
    <form action="login.php" method="POST" class="bunda" style=margin-bottom:12%;>
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="exampleInputEmail1" required aria-describedby="emailHelp" placeholder="Email do usuário" name="email">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Senha:</label>
            <input type="password" class="form-control"  required id="exampleInputPassword1" placeholder="Senha do usuário" name="senha">
        </div>
