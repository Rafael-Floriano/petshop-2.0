...
<div class="" style="background-color: #292929;">
    <div class="">
      <div class="d-flex" style="justify-content: space-between; margin: auto 5%;">
        <div>
        ...
        <div style="margin-right:1.5%;">
          ...
          <div class="text-center">
            <img src="Icons/insta.png" style="width: 60px; margin: auto 5%;" alt="">
            <img src="Icons/facebook.jpg" style="width: 42px; border-radius: 10px; margin: auto 5%;" alt="">
            <img src="Icons/zap.jpg" style="width: 44px; border-radius:10px; margin: auto 5%;" alt="">
          </div>
        </div>
      </div>
    </div>
